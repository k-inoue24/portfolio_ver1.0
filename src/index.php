...
<body>
    ...
    <div class="service" id="service">
        <div class="container">
            <h2 data-aos="fade-zoom-in" data-aos-easing="ease-in-back" data-aos-offset="0" data-aos-anchor-placement="bottom-bottom">SERVICE <span>-各制作サービス-</span></h2>
            <div class="flex" data-aos="fade-zoom-in" data-aos-delay="500" data-aos-anchor-placement="top-center">
                <div class="flex_img">
                    <img src="<?php echo get_template_directory_uri(); ?>/img/corporate-site.png" width="75%" alt="ランディングページ/コーポレイトサイト">
                </div>
                <div class="flex_text">
                    <div class="flex_text_inner">
                        <h3>ランディングページ<br class="br_slash"><span class="slash">/</span>コーポレイトサイト制作</h3>
                        <span class="h3_border"></span>
                        <p>販促を目的とした1枚のランディングページや、複数ページを持つコーポレイトサイトの制作を担当します。サイトの目的に応じたデザインの提案が可能です。すでにデザイン案をお持ちの場合は、コーディングの代行をお任せください。</p>
                    </div>
                </div>
            </div>
            <div class="flex" data-aos="fade-zoom-in" data-aos-anchor-placement="top-center">
                <div class="flex_img">
            ...
            <div class="circle_line" data-aos="fade-zoom-in" data-aos-easing="ease-in-back" data-aos-offset="0">
                <div></div>
                <div></div>
                <div></div>
            </div>
    ...
    <div class="contact" id="contact">
        <div class="container">
            <h2 data-aos="fade-zoom-in" data-aos-easing="ease-in-back" data-aos-anchor-placement="bottom-bottom">CONTACT<span>-お問い合わせ-</span></h2>
            <div>
    ...
    <div class="links" id="links" data-aos="fade-zoom-in" data-aos-easing="ease-in-back">
        <h2>LINKS<span>-外部リンク-</span></h2>
        <div>
